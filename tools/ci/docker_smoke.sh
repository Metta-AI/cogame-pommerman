...
# Substitute: pommerman, coworld-pommerman, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-pommerman:ci)
#   SMOKE_SLUG                 game slug                        (pommerman)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/pommerman)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/pommerman-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-pommerman:ci}}"
slug="${SMOKE_SLUG:-pommerman}"
