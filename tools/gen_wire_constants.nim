## Emits the JS wire-constants block (src/pommerman/wire_constants.nim) on
...
## and injects a <script src> for it into the bundled page -- same constants,
## same source, different delivery.
import ../src/pommerman/wire_constants
